...
def process_folder(engine, cfg, folder_path, sectional_commit=False, pause_file=".etl_pause.json", cool_down_seconds=0):
...
def run(data_root="Data", etl_config_path=None, db_config=None, sectional_commit=False, cool_down_seconds=0, resume=False, pause_file=".etl_pause.json"):
    ...
    for folder in folders:
        try:
            process_folder(engine, cfg, folder, sectional_commit=sectional_commit, pause_file=pause_file, cool_down_seconds=cool_down_seconds)
        except FolderPaused:
